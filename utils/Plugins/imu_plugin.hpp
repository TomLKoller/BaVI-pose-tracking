...
::plugin {
	...
	public:
		 ...
		 */
		virtual inline const Eigen::Vector3d & getAcceleration() const{
			return acceleration;
		}
		 ...
		 */
		virtual inline const Eigen::Vector3d & getAngularVelocity() const{
		 ...
		 */
		virtual inline const Eigen::Vector3d & getMagnetometer()const{
			return magnetometer;
		}
		 ...
		 *
		 * @return   imu_in_world as euler angles
		 */
		virtual inline const Eigen::Quaterniond & getOrientation() const{
			return imu_in_world;
		}
		 ...
		 */
		virtual inline const Eigen::Matrix3d & getAccelerationCov() const{
		 ...
		 */
		virtual inline const Eigen::Matrix<double, 6, 6> & getAccelerationBiasCov()const {
		 ...
		 */
		virtual inline const Eigen::Matrix<double, 6, 1>& getAccelerationBiasCorr() const{
		 ...
		 * @return Matrix covariance  of x,y,z acceleration
		 */
		virtual inline const Eigen::Matrix3d  getAngularRateBiasCov() const{
		 ...
		 */
		virtual inline const Eigen::Vector3d & getAngularRateBiasCorr() const{
		 ...
		 */
		virtual inline const Eigen::Matrix3d & getAngularVelocityCov() const{
		 ...
		 */
		virtual inline const Eigen::Matrix3d & getMagnetometerCov() const{
		 ...
		 *
		 * @return Matrix covariance  of imu_in_world
		 */
		virtual inline const Eigen::Matrix3d & getOrientationCov() const{
	...
	protected:
		...
		orientation_cov;//< covariance of imu_in_world
		Eigen::Quaterniond imu_in_world;//<imu_in_world data
